...
function setup() {
	...
	add_action( 'template_redirect', $n( 'homepage_redirect' ) );
...
/**
 * Redirect all frontend pages to the homepage, except for the homepage itself.
 * Ensures admin pages and backend requests are not affected.
 */
